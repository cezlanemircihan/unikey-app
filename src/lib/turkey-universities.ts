export const turkeyUniversities = [
...
export const universityDepartments: Record<string, string[]> = {};

export function getDepartmentsForUniversity(university: string) {
  return universityDepartments[university] ?? [...commonDepartments];
}
